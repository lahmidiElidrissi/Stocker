                        ...
                        <div class="row">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control select2" id="contenir_id" name="contenir_id">
                                        ...
                                        @foreach ($contenirs as $contenir)
                                            <option value="{{ $contenir->id }}" {{ old('contenir_id') == $contenir->id ? 'selected' : '' }}>
                                                {{ $contenir->Referance }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" id="tax_amount" name="tax_amount" value="{{ old('tax_amount', 0) }}" readonly>
                                </div>
...
function addArticleToTable(id, code, name, price, quantity) {
    ...
    if (existingArticleIndex !== -1) {
        ...
        newRow.innerHTML = `
            ...
            <td id="article_total_${articleData.index}">${(price * quantity).toFixed(2)}</td>
            <td>
...
function removeArticle(index) {
    const articleIndex = commandeArticles.findIndex(a => a.index === index);
    if (articleIndex !== -1) {
        console.log("Removing article:", commandeArticles[articleIndex].name);
...
function updateHiddenInputs() {
    ...
    console.log("Article inputs updated:", commandeArticles.length, "articles");
    commandeArticles.forEach((article, index) => {
        console.log(`Article ${index}:`, article.id, article.name, article.quantity, article.price);
    });
}
