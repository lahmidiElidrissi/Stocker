                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control" id="date" name="date" value="{{ old('date', $achat->date) }}" required>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control select2" id="contenir_id" name="contenir_id">
                                        ...
                                        @foreach ($contenirs as $contenir)
                                            <option value="{{ $contenir->id }}" {{ old('contenir_id', $achat->contenir_id) == $contenir->id ? 'selected' : '' }}>
                                                {{ $contenir->Referance }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" id="tax_amount" name="tax_amount" value="{{ old('tax_amount', $achat->tax_amount) }}" readonly>
                                </div>
