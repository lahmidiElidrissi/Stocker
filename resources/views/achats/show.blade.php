                    ...
                    <div class="card-body">
                        ...
                        <div class="purchase-meta">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <span class="info-label">TVA
                                            ({{ number_format($achat->tax_rate ?? 0, 2) }}%):</span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    <thead class="bg-light">
                                        <tr>
                                            <th width="5%">#</th>
                                            <th width="12%">Code-barres</th>
                                            <th width="18%">Article</th>
                                            <th width="11%">Prix details</th>
                                            <th width="11%">Prix de gros</th>
                                            <th width="11%">Prix d'achat</th>
                                            <th width="11%">Prix d'importation</th>
                                    ...
                                    <tbody>
                                        @forelse($achat->articles as $index => $item)
                                            <tr>
                                                ...
                                                <td>{{ number_format($item->prix_details ?? 0, 2) }} Dh</td>
                                                <td>{{ number_format($item->prix_gros ?? 0, 2) }} Dh</td>
                                                <td>{{ number_format($item->prix_achat ?? 0, 2) }} Dh</td>
                                                <td>{{ number_format($item->prix_importation ?? 0, 2) }} Dh</td>
                                                <td>{{ $item->Quantite }}</td>
                                                <td>{{ number_format($item->prix_importation * $item->Quantite, 2) }} Dh
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                                                <td colspan="9" class="text-center py-3">Aucun article trouvé pour cet
                                                    achat.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                    <tfoot>
                                        <tr class="total-row">
                                            ...
                                            <td>{{ number_format(
                                                $achat->articles->sum(function ($item) {
                                                    return $item->prix_importation * $item->Quantite;
                                                }),
                                                2,
                                            ) }}
                                                Dh</td>
