                        ...
                        <div class="card-body">
                            <div class="d-md-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <a href="{{ route('commandes.pdf.view', $commande->id) }}" class="btn btn-info"
                                        target="_blank">
                                    ...
                                    <a href="{{ route('commandes.pdf.download', $commande->id) }}" class="btn btn-success">
                                        <i class="mdi mdi-download"></i> <span class="d-none d-sm-inline">Télécharger
                                            PDF</span>
                                    </a>
                                    <a href="{{ route('commandes.ticket.view', $commande->id) }}" class="btn btn-warning"
                                        target="_blank">
                                        <i class="mdi mdi-receipt"></i> <span class="d-none d-sm-inline">Ticket</span>
                                    </a>
                                        ...
                                        <table class="table table-bordered mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">{{ number_format($commande->tax_amount, 2) }} Dh
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="bg-light fw-bold">Total TTC</th>
                                                    <td class="text-end fw-bold">{{ number_format($commande->total, 2) }}
                                                        Dh</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end text-danger fw-bold">
                                                        {{ number_format($commande->du, 2) }} Dh</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <table class="table table-bordered table-striped">
                                        ...
                                        @if (isset($commande->articles) && count($commande->articles) > 0)
                                            @foreach ($commande->articles as $index => $item)
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        {{ number_format($item->Quantite * $item->CustomPrix, 2) }} Dh</td>
                                                </tr>
                                            @endforeach
                                        @else
                                            <tr>
                                                <td colspan="5" class="text-center">Aucun article dans cette commande
                                                </td>
                                            </tr>
                                        @endif
                                    </tbody>
                                    <tfoot class="bg-light">
                                        <tr>
                                            ...
                                            <td class="text-end fw-bold">{{ number_format($commande->subtotal, 2) }} Dh
                                            </td>
                                        </tr>
                                        <tr>
